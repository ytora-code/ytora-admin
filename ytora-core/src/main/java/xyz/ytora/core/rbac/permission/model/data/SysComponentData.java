...
public class SysComponentData implements SqlReader, SqlWriter {
    ...
    @Override
    public SysComponentData read(Object o) {
        if (o == null) {
            return null;
        }
        String string = o.toString();
        return Jsons.fromJsonStr(string, SysComponentData.class);
    }
            ...
            try {
                ...
                if (value instanceof String strVal) {
                    ...
                    // 如果value是true或false，直接转换
                        ...
                        BigDecimal decimalVal = new BigDecimal(strVal);
